...
def intercep_eeg(data,sample,tmin=-0.25,tmax=0.25):
    freq = 250
    batch_data = []
    for i in sample:
...
if __name__ == '__main__':
    ...
    for sub_num in sub_list:
        ...
        torch.save(torch.from_numpy(concate_eeg), save_dir + f'/eeg_raw_sub{sub_num}_bloom1.1.pth')
