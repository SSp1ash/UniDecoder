    ...
    with torch.no_grad():
        ...
        for lan in lan_list:
            ...
            for run, TR_num in TR.items():
                ...
                utils.base.create_folder_if_not_exists(config.project_lfs_path + f'/LPPC-fMRI/dataset/word_times_bloom_fr')
                np.save(config.project_lfs_path + f'/LPPC-fMRI/dataset/word_times_bloom_fr/word_times_story{run}.npy', word_time)
            ...
            torch.save(emb,
                       config.project_lfs_path + f'/LPPC-fMRI/dataset/fMRI/eb_bloom1.1_{lan}_split{split}_{layer}layer.pth')
            torch.save(emb_downsample,
                       config.project_lfs_path + f'/LPPC-fMRI/dataset/fMRI/eb_bloom1.1_{lan}_split{split}_{layer}layer_downsample.pth')
            ...
            torch.save(fmri_resample,
                       config.project_lfs_path + f'/LPPC-fMRI/dataset/fMRI/fMRI_raw_sub{sub_num}_bloom_roi.pth')
