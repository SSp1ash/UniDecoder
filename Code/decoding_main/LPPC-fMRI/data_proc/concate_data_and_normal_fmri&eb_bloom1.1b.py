    ...
    with torch.no_grad():
        ...
        for lan in lan_list:
            ...
            for run, TR_num in TR.items():
                ...
                np.save(config.project_lfs_path + f'/LPPC-fMRI/dataset/word_times_bloom/word_times_story{run}.npy', word_time)
            ...
            torch.save(emb,config.project_lfs_path + f'/LPPC-fMRI/dataset/fMRI/eb_bloom1.1_{lan}_split{split}_{layer}layer.pth')
            torch.save(emb_downsample, config.project_lfs_path + f'/LPPC-fMRI/dataset/fMRI/eb_bloom1.1_{lan}_split{split}_{layer}layer_downsample.pth')
