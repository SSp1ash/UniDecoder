...
def windows_compare():
    ...
    for story in story_list:
        ...
        for i in range(start, end + 1):
            ...
            rec_path = glob.glob(config.result_path + f'/exp5/SMN4Lang/story{story}/*sub{str(i).zfill(2)}*{data}{data_type}.npy')[0]
    ...
    if remove_pun == 0:
        results_df.to_csv(config.result_path + f'/exp5/SMN4Lang/SMN4Lang_fMRI_{data}{data_type}_story{story}_20250423_v2.csv', index=False,
                          encoding='utf-8')
    else:
        results_df.to_csv(config.result_path + f'/exp5/SMN4Lang/SMN4Lang_fMRI_{data}{data_type}removePUN_story{story}_20250423_v2.csv', index=False,
                          encoding='utf-8')
