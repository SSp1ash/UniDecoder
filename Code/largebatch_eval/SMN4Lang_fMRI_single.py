...
def windows_compare():
    ...
    for story in story_list:
        ...
        for i in range(start, end + 1):
            ...
            # rec = np.load(config.result_path + f'/largebatch/SMN4Lang_fMRI/story{story}/SMN4Lang_sub{str(i).zfill(2)}_test_20241212_text.npy')
            rec = np.load(config.result_path + f'/largebatch/SMN4Lang_fMRI/story{story}/SMN4Lang_sub{str(i).zfill(2)}_test_20250404_text.npy')
    ...
    results_df.to_csv(config.result_path + '/largebatch/excels/SMN4Lang/SMN4Lang_fMRI_singlesubmodel_windows_20250404.csv', index=False,
                      encoding='utf-8')
