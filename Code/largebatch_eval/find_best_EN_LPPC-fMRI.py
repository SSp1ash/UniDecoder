...
def windows_compare():
    ...
    for story in story_list:
        ...
        for sub_path in sub_list:
            ...
            gt = np.load(config.project_lfs_path + f'/LPPC-fMRI/dataset/word_compare_gt/story{story}_EN.npy')[:-4]
    ...
    results_df.to_csv(config.result_path + '/largebatch/excels/LPPC-fMRI/fMRI_singlesubmodel_windows_EN.csv', index=False,
                      encoding='utf-8')
