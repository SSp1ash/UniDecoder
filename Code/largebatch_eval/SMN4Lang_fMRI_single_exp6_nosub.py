...
def windows_compare():
    ...
    for story in story_list:
        ...
        for i in range(start, end + 1):
            ...
            rec_path = glob.glob(config.result_path + f'/exp6/SMN4Lang/story{story}/{data_type}/*sub{str(i).zfill(2)}*nosublayer*{data}*.npy')[0]
    ...
    if remove_pun == 1:
        results_df.to_csv(config.result_path + f'/exp6/SMN4Lang/SMN4Lang_fMRI_{data}_nosublayer_{data_type}removePUN.csv', index=False,
                          encoding='utf-8')
    else:
        results_df.to_csv(config.result_path + f'/exp6/SMN4Lang/SMN4Lang_fMRI_{data}_nosublayer_{data_type}.csv', index=False,
                          encoding='utf-8')
