...
if __name__ == '__main__':
    ...
    for sub_num in sub_list:
        ...
        np.savez_compressed('../dataset/SMN4Lang/train_texteb_data', texteb_normal)
        np.savez_compressed(f'../dataset/SMN4Lang/train_fmri_1Ddata-sub{sub_num}', data_normal)
        ...
        np.savez_compressed('../dataset/SMN4Lang/test_texteb_data', texteb_normal)
        np.savez_compressed(f'../dataset/SMN4Lang/test_fmri_1Ddata-sub{sub_num}', data_normal)