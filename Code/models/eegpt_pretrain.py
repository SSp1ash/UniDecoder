...
class PatchNormEmbed(nn.Module):
    ...
    def __init__(self, img_size=(64, 1000), patch_size=16, patch_stride=None, embed_dim=768):
        ...
        self.unfold = torch.nn.Unfold(kernel_size=(1, patch_size),
    ...
    def __init__(
        ...
        self.reconstructor_blocks = nn.ModuleList([
            Block(
                ...
                drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, is_causal=False,
                use_rope=True,
...
if __name__ == '__main__':
    ...
    # 如果checkpoint包含'state_dict'键，说明是Lightning格式
    ...
    x = torch.rand([32,58,1024]).to(device)
    y = model(x)
