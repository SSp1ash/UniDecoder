...
#             candidates = candidates - candidates.mean(dim=(1, 2), keepdim=True)
#
#         # ✅ 双向L2归一化（标准的cosine similarity）
#         estimates = F.normalize(estimates, p=2, dim=(1, 2))
#         candidates = F.normalize(candidates, p=2, dim=(1, 2))
#
#         # ✅ 计算cosine similarity并除以温度
#         scores = torch.einsum("bct,oct->bo", estimates, candidates) / self.temperature
#
#         return scores
#
#     def get_probabilities(self, estimates, candidates):
